...
export const Projects = () => {
  return (
    <section className="flex flex-col pb-10">
      <div id="restricted-work" className="pt-12 resp-width">
      ...
      <div id="public-work" className="py-[100px] resp-width md:ml-auto">
        <h1 className="md:text-right">Meanwhile...</h1>
        <p className="pt-12 md:text-right">
          You can always browse the projects I’ve done in the past which helped me refine my design skills, challenged
          me to think about the project as a system and solidified my design language.
        </p>
      </div>
      <ProjectCard
        year="2022"
